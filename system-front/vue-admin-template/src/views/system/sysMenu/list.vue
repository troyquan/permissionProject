<template>
    <div class="app-container">
      ...
      <el-table
        ...
        <el-table-column prop="name" label="Menu Name" width="160"/>
        <el-table-column label="Icon">
          <template slot-scope="scope">
            <i :class="scope.row.icon"></i>
          </template>
        </el-table-column>
        <el-table-column prop="perms" label="Perms Name" width="160"/>
        <el-table-column prop="path" label="Router" width="120"/>
        <el-table-column prop="component" label="Component " width="160"/>
        ...
        <el-table-column label="Operation" width="180" align="center" fixed="right">
          <template slot-scope="scope">
            ...
            <el-button type="primary" icon="el-icon-edit" size="mini" @click="edit(scope.row)" title="Edit"/>
            <el-button type="danger" icon="el-icon-delete" size="mini" @click="removeDataById(scope.row.id)" title="Delete" :disabled="scope.row.children.length > 0"/>
          </template>
        </el-table-column>
      </el-table>
      ...
      <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="40%" >
        <el-form ref="dataForm" :model="sysMenu" label-width="150px" size="small" style="padding-right: 40px;">
          <el-form-item label="Parent Dept" v-if="sysMenu.id === ''">
            <el-input v-model="sysMenu.parentName" disabled="true"/>
          </el-form-item>
          <el-form-item label="Menu Type" prop="type">
            <el-radio-group v-model="sysMenu.type" :disabled="typeDisabled">
              <el-radio :label="0" :disabled="type0Disabled">Content</el-radio>
          ...
          <el-form-item prop="path">
            ...
            <el-input v-model="sysMenu.path" placeholder="Enter Router" />
          </el-form-item>
          <el-form-item prop="component" v-if="sysMenu.type !== 0">
            ...
            <el-input v-model="sysMenu.component" placeholder="Component Path" />
          </el-form-item>
          <el-form-item v-if="sysMenu.type === 2">
            <el-input v-model="sysMenu.perms" placeholder="Permssion" maxlength="100" />
            <span slot="label">
          ...
          <el-form-item label="Status" prop="type">
            <el-radio-group v-model="sysMenu.status">
              ...
              <el-radio :label="0">Suspended</el-radio>
            </el-radio-group>
          </el-form-item>
        </el-form>
